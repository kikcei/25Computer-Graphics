...
#include "ShapeBuffer.h"
                                            ...
                                            // 직사각형 길이 , 가시 간격, 각도
BasicObstacle::BasicObstacle(glm::vec3 pos, float length, float spacing, float initialAngle)
...
void BasicObstacle::Draw(const glm::mat4& view, const glm::mat4& proj, GLuint mvpLoc)
{
    // --- 공통 회전 모델 행렬 ---
...
void BasicObstacle::Update(float dt)
{
